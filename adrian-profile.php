  ...
  <body>
    ...
    <div class="page">
      ...
      <section class="section-page-title context-dark" style="background-image: url(images/page-title-1920x427.jpg); background-size: cover;">
        <div class="container">
          <h1 class="page-title">Adrian Profile</h1>
        </div>
      </section>
          ...
          <div class="row row-50">
            <div class="col-lg-5 col-xl-4 text-center">
              <div class="row row-30 row-lg-50">
                <div class="col-12"><img class="img-shadow" src="images/adrian-370x370.jpg" alt="" width="370" height="370"/>
                </div>
            ...
            <div class="col-lg-7 col-xl-8">
              <div class="box-team-info">
                ...
                <p>15 years ago he stepped into the tattoo industry armed with a graphic design background. Now he stands at the top of the game, specialising in colourful works of art and pop cultural inspired pieces.</p>
                <div class="quote-bordered">
                  <div class="quote-caption">
                    ...
                    <h3 class="quote-text">Tattoos represent who you are, what you like and how much you want to show it.</h3>
                  </div>
                </div>
