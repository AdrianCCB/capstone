  ...
  <body>
    ...
    <div class="page">
                ...
                <div class="rd-navbar-main-element">
                  <div class="rd-navbar-nav-wrap">
                    ...
                    <ul class="rd-navbar-nav">
                      ...
                      <li class="rd-nav-item"><a class="rd-nav-link" href="our-team ">About</a>
                        <!-- RD Navbar Dropdown -->
                        <ul class="rd-menu rd-navbar-dropdown">
                          <li class="rd-dropdown-item active"><a class="rd-dropdown-link" href="our-team ">Our Team</a></li>
                        </ul>
                      </li>
                      ...
                      <li class="rd-nav-item"><a class="rd-nav-link" href="appointment ">Appointment</a>
                      </li>
      ...
      <section class="section-page-title context-dark" style="background-image: url(images/page-title-1920x427.jpg); background-size: cover;">
        <div class="container">
          <h1 class="page-title">Jack Profile</h1>
        </div>
      </section>
      <section class="breadcrumbs-custom">
        <div class="container">
          <ul class="breadcrumbs-custom-path">
            ...
            <li class="active">Jack Profile</li>
          </ul>
        </div>
      </section>
          ...
          <div class="row row-50">
            <div class="col-lg-5 col-xl-4 text-center">
              <div class="row row-30 row-lg-50">
                <div class="col-12"><img class="img-shadow" src="images/Jackpf.jpeg" alt="" width="370" height="370"/>
                </div>
            ...
            <div class="col-lg-7 col-xl-8">
              <div class="box-team-info">
                ...
                <p>Spent 5 years at the famous Celebrity Ink Tattoo in Phuket before freelancing for another 5 in Singapore. Jack prides himself with the abstract, using uunique flowy waves and patterns. No two tattoo from him will ever be the same.</p>
                <div class="quote-bordered">
                  <div class="quote-caption">
                    ...
                    <h3 class="quote-text">Tattooing is a unique experience and for that experience the results has to be unique as well.</h3>
                  </div>
                </div>
            ...
            <div class="col-lg-10">
              <div class="footer-nav">
                <ul class="rd-navbar-nav">
                  ...
                  <li class="rd-nav-item"><a class="rd-nav-link" href="our-team ">About</a></li>
                  ...
                  <li class="rd-nav-item"><a class="rd-nav-link" href="appointment ">Appointment</a></li>
